...
import { formDataToObject, shortenAddress } from "../../lib/utilFunctions";
...
export default function CreateSubmissionStepper() {
    const toast = useToast();
    const { isConnected, address } = useState(null);
    ...
    const [_totalAmountTokensUserNeedForLaunch, setTotalAmountTokensUserNeedForLaunch] =
        useState(0);
        ...
        if (tokenAddress && isConnected) {
            const getTokenDetails = async () => {
                try {
                    ...
                    const token_name = null;
                    const token_symbol = null;
                    const total_supply = null;
    ...
    const handleFinish = async () => {
        try {
            ...
            setTotalAmountTokensUserNeedForLaunch(totalAmountTokensUserNeedForLaunch);

            const signer = await getEthersSigner(config);
            const factory = new ethers.Contract(LaunchFactory, LaunchFactoryAbi, signer);
    ...
    const listingRate =
        presaleAmount / hardCap + ((presaleAmount / hardCap) * listingRatePercentage) / 100 ?? 0;
        ...
        try {
            ...
            if (tokenomics.ok) {
                ...
                const getStaking = async () => {
                    const value = tokenomicsData?.stakeAddresses?.reduce(
                        async (total, stake_address) => {
                            const stakerBalance = await tokenContract.balanceOf(stake_address);
                            return total + Number(stakerBalance ? formatUnits(stakerBalance) : 0);
                        },
                        0
                    );
                    return value || 0;
                ...
                let staking = await getStaking();

                const liquidity = ((hardCap * liquidityPercentage) / 100 ?? 0) * listingRate;
                ...
                const unlocked =
                    ...
                    (Number(presaleAmount) +
                        Number(staking) +
                        Number(liquidity) +
                        Number(tokenomicsData?.totalLockAmount) || 0 + burnt);
                                            ...
                                            <div className="relative flex flex-col w-full gap-1 mb-6 lg:w-1/2">
                                                <div className="mb-1">
                                                    ...
                                                    <p className="text-[#898582] text-xs">
                                                        Token you will raise the liquidity and
                                                        funding in
                                                    </p>
                                                </div>
                                                {/* <input
                      ...
                      /> */}
                                            ...
                                            <div className="relative flex flex-col w-full gap-1 mb-6 lg:w-1/2">
                                                <div className="mb-1">
                                                    ...
                                                    <p className="text-[#898582] text-xs">
                                                        Only account that can add, edit presale
                                                        contract information & unlock liquidity
                                                    </p>
                                                </div>
                                                <div
                                                    id="presale_creator"
                                        ...
                                        <div className="flex flex-wrap items-center w-full gap-5 lg:flex-nowrap">
                                            ...
                                            <div className="relative flex flex-col w-full gap-1 mb-6 lg:w-1/2">
                                                <div className="mb-1">
                                                    <label className="text-sm text-[#FFFCFB] mb-1">
                                                        How many {tokenDetails?.token_symbol} are up
                                                        for presale?
                                                    </label>
                                                    <p className="text-[#898582] text-xs">
                                        ...
                                        <div className="flex flex-wrap items-center w-full gap-5 lg:flex-nowrap">
                                            <div className="relative flex flex-col w-full gap-1 mb-6 lg:w-1/2">
                                                <div className="mb-1">
                                                    ...
                                                    <p className="text-[#898582] text-xs">
                                                        Minimum amount of funds raised. It needs to
                                                        be 30% of Hard cap
                                                    </p>
                                                </div>
                                        ...
                                        <div className="flex flex-wrap items-center w-full gap-5 lg:flex-nowrap">
                                            ...
                                            <div className="relative flex flex-col w-full gap-1 mb-6 lg:w-1/2">
                                                <div className="mb-1">
                                                    ...
                                                    <p className="text-[#898582] text-xs">
                                                        Amount changes based on min allocation per
                                                        user
                                                    </p>
                                                </div>
                                            ...
                                            <div className="relative flex flex-col w-full gap-1 mb-6 lg:w-1/2">
                                                <div className="mb-1">
                                                    ...
                                                    <p className="text-[#898582] text-xs">
                                                        Amount changes based on max allocation per
                                                        user
                                                    </p>
                                                </div>
                                        ...
                                        <div className="flex flex-wrap items-start w-full gap-5 lg:flex-nowrap">
                                            ...
                                            <div className="relative flex flex-col w-full gap-1 mb-6 lg:w-1/2">
                                                <div className="mb-1">
                                                    ...
                                                    <p className="text-[#898582] text-xs">
                                                        This is the percent of presale rate you want
                                                        to list
                                                    </p>
                                                </div>
                                                <input
                                                ...
                                                <div className="flex items-center gap-2 mt-1">
                                                    {[0, 10, 15, 25, 30].map((percent) => (
                                                        <button
                                                            ...
                                                            type="button"
                                                            onClick={() =>
                                                                setListingRatePercentage(percent)
                                                            }
                                        ...
                                        <div className="flex flex-wrap items-center w-full gap-5 lg:flex-nowrap">
                                            ...
                                            <div className="relative flex flex-col w-full gap-1 mb-6 lg:w-1/2">
                                                <div className="mb-1">
                                                    ...
                                                    <p className="text-[#898582] text-xs">
                                                        End date needs to be set as minimum 24h of
                                                        start date
                                                    </p>
                                                </div>
                                                <input
                                        ...
                                        <div className="flex flex-wrap items-center w-full gap-5 lg:flex-nowrap">
                                            <div className="relative flex flex-col w-full gap-1 mb-6 lg:w-1/2">
                                                <div className="mb-1">
                                                    ...
                                                    <p className="text-[#898582] text-xs">
                                                        Estimated period where liquidity would be
                                                        locked
                                                    </p>
                                                </div>
                                                <select
                                            ...
                                            <div className="relative flex flex-col w-full gap-1 mb-6 lg:w-1/2">
                                                <div className="mb-1">
                                                    ...
                                                    <p className="text-[#898582] text-xs">
                                                        Select your country of operation. Where is
                                                        your business headquartered
                                                    </p>
                                                </div>
                                                <select
                                                    id="country"
