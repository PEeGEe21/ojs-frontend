...
const Sidebar = ({ user }) => {
  ...
  const wrapperClasses = classNames(
    'h-full sidebar pb-4 bg-[#008080] lg:flex justify-between shadow-sm scrollbar-change flex-col overflow-y-auto overflow-x-hidden border-r-[0.5px] border-[#F3F4F6] hidden w-48 z-50'
  );
